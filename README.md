...
- **Typed Custom Properties**: Component Pack의 `propertyDefinitions`로 String·Boolean·Integer·Double·Color·Enum·Thickness·CornerRadius, 숫자 범위·Enum 옵션, 표시 이름·카테고리·설명을 선언하고 Inspector 카테고리 그룹·검색·선택·스핀·색상·4방향 편집기와 공통 검증을 적용
